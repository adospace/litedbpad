...
namespace LiteDBPad
{
    public class ConnectionDialogViewModel : INotifyPropertyChanged
    {
        ...
        internal void SaveTo(ConnectionProperties cxProperties)
        {
            ...
            cxProperties.Mode = this.Mode;
            cxProperties.InitialSize = InitialSize;
            cxProperties.ReadOnly = ReadOnly;
            cxProperties.Upgrade = Upgrade;
        ...
        internal void LoadFrom(ConnectionProperties cxInfo)
        {
            ...
            Upgrade = cxInfo.Upgrade;
            ReadOnly = cxInfo.ReadOnly;
        ...
        public IEnumerable<ConnectionType> Modes => Enum.GetValues(typeof(ConnectionType))
            .Cast<ConnectionType>();

        private ConnectionType _mode = default;
